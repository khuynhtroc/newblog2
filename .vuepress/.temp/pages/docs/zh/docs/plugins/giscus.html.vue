...
<p><code v-pre>vuepress-plugin-giscus@next</code> 插件：在 <a href="https://v2.vuepress.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">VuePress 2<ExternalLinkIcon/></a> 中使用基于 <a href="https://docs.github.com/en/discussions" target="_blank" rel="noopener noreferrer">GitHub Discussions<ExternalLinkIcon/></a> 的评论系统 <a href="https://github.com/giscus/giscus" target="_blank" rel="noopener noreferrer">Giscus<ExternalLinkIcon/></a>。</p>
...
<p>首先你需要：</p>
<ul>
<li>建一个公开的 Github 仓库并<a href="https://docs.github.com/cn/repositories/managing-your-repositorys-settings-and-features/enabling-features-for-your-repository/enabling-or-disabling-github-discussions-for-a-repository" target="_blank" rel="noopener noreferrer">启用 Discussions<ExternalLinkIcon/></a></li>
<li>安装 <a href="https://github.com/apps/giscus" target="_blank" rel="noopener noreferrer">Giscus app<ExternalLinkIcon/></a>，在选择仓库时至少要把上述仓库选进去</li>
<li>查看 <a href="https://giscus.app" target="_blank" rel="noopener noreferrer">Giscus 官网<ExternalLinkIcon/></a>并在上面生成你的 repo id、category id 以及别的必要信息</li>
</ul>
<h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置" aria-hidden="true">#</a> 配置</h2>
<p>在 <code v-pre>.vuepress/config.js</code> 中引入这个插件：</p>
...
<p>这时 <code v-pre>Giscus</code> 就已经被注册为一个 Vue 组件了，因此你可以直接在 Vuepress 中使用它。你也可以通过传入 props 来实时改变 Giscus 的主题、语言和启用或关闭 reaction（<a href="https://github.com/giscus/giscus/blob/main/ADVANCED-USAGE.md#parent-to-giscus-message-events" target="_blank" rel="noopener noreferrer">工作原理<ExternalLinkIcon/></a>）：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="开源协议" tabindex="-1"><a class="header-anchor" href="#开源协议" aria-hidden="true">#</a> 开源协议</h2>
