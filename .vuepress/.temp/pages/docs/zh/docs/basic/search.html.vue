...
<p>主题内置的搜索组件修改自 <a href="https://v2.vuepress.vuejs.org/zh/reference/plugin/search.html" target="_blank" rel="noopener noreferrer">@vuepress/plugin-search<ExternalLinkIcon/></a>，它只支持搜索<strong>博客文章</strong>（即不支持文档文章）。它在本地生成你的博客文章的搜索索引，然后在用户访问站点时加载搜索索引文件，即它不会进行任何外部请求。</p>
<p>效果可以参考<a href="https://blog.zxh.io" target="_blank" rel="noopener noreferrer">这里<ExternalLinkIcon/></a>（点击导航栏的 Search）。</p>
...
<li>可以作为一般配置使用，也可以在 <a href="https://v2.vuepress.vuejs.org/zh/reference/default-theme/config.html#locales" target="_blank" rel="noopener noreferrer">locales<ExternalLinkIcon/></a> 配置项内使用</li>
</ul>
</li>
<li>
<p>示例：</p>
...
<li>
<p>参考：<a href="https://v2.vuepress.vuejs.org/zh/guide/i18n.html" target="_blank" rel="noopener noreferrer">指南 &gt; 多语言支持<ExternalLinkIcon/></a></p>
</li>
</ul>
...
<ul>
<li>
<p>指定热键的 <a href="http://keycode.info/" target="_blank" rel="noopener noreferrer">event.key<ExternalLinkIcon/></a> ，当按下热键时，搜索框会被聚焦</p>
</li>
<li>
...
<p>如果你有搜索文档文章的需求，可以考虑使用官方搜索插件 <a href="https://v2.vuepress.vuejs.org/zh/reference/plugin/search.html" target="_blank" rel="noopener noreferrer">@vuepress/plugin-search<ExternalLinkIcon/></a> 或 <a href="https://v2.vuepress.vuejs.org/zh/reference/plugin/docsearch.html" target="_blank" rel="noopener noreferrer">@vuepress/plugin-docsearch<ExternalLinkIcon/></a>。按照官方文档上的方式安装和配置即可，配置完后本主题会把搜索框添加到导航栏，效果参考本站右上角。同时你可能会想要<a href="#%E7%A6%81%E7%94%A8">禁用</a>默认搜索组件。</p>
